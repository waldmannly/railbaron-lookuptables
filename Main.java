//RailBarronAssistant Main.java 06/12/2006
package railbarron;
...
/**
 * The simple main class for launching the double click application.
 * <P>
 * <TABLE BORDER="0">
 * <TR>	<TD><H4>Main.java</H4></TD>
...
public final class Main {
	...
	/**
	 * The main method invoked on double click.
	 * <P>
	 * @param args ignored.
	 */
	public static void main(String[] args) {
		try {
			new RailBarronAssistantApp();
		} catch (Throwable t) {
			StringWriter s = new StringWriter();
			Throwable tc = t.getCause();
			if (tc != null)
				tc.printStackTrace(new PrintWriter(s));
			else
